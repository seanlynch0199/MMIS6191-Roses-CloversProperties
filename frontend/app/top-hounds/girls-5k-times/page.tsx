...
import { girls5kAllTime } from '@/data/records'

export default function Girls5kTimesPage() {
  const top3 = girls5kAllTime.slice(0, 3)
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-8">
        The fastest 5K cross country times ever run by Pine Ridge girls.
      </p>
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        ...
        <div className="mt-8">
          <div className="bg-gray-200 dark:bg-gray-700 rounded-t-lg p-4 text-center">
            ...
            <div className="font-mono font-bold text-prGreen-600 dark:text-prGreen-400">{top3[1]?.time}</div>
        ...
        <div>
          <div className="bg-yellow-100 dark:bg-yellow-900/30 rounded-t-lg p-4 text-center border-2 border-yellow-400">
            ...
            <div className="font-mono font-bold text-prGreen-600 dark:text-prGreen-400 text-lg">{top3[0]?.time}</div>
        ...
        <div className="mt-12">
          <div className="bg-orange-100 dark:bg-orange-900/30 rounded-t-lg p-4 text-center">
            ...
            <div className="font-mono font-bold text-prGreen-600 dark:text-prGreen-400">{top3[2]?.time}</div>
          ...
          <tbody>
            {girls5kAllTime.map((runner, index) => (
              ...
              >
                ...
                <td className="py-3 px-4 font-mono font-bold text-prGreen-600 dark:text-prGreen-400">{runner.time}</td>
