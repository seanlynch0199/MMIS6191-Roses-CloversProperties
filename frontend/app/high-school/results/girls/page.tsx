...
function ResultsContent() {
  ...
  const allResults = getResultsByTeamLevelAndGender('hs', 'girls')
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
        Girls {getSeasonName(season)} Results
      </h1>
      <p className="text-gray-600 dark:text-gray-400 mb-8">
        Meet results and individual performances for the high school girls team.
...
export default function GirlsResultsPage() {
  return (
