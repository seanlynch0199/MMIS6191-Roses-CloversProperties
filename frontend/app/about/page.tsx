    ...
    <div className="min-h-screen bg-stone-100">
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-sm p-8 mb-6 border border-stone-200">
            <div className="max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                <div className="bg-stone-50 rounded-xl p-6 border border-stone-100">
                  <div className="w-12 h-12 bg-clover-100 rounded-full flex items-center justify-center mb-4">
                  ...
                  <h3 className="font-semibold text-stone-900 mb-2">Integrity</h3>
                ...
                <div className="bg-stone-50 rounded-xl p-6 border border-stone-100">
                  ...
                  <h3 className="font-semibold text-stone-900 mb-2">Care</h3>
                  <p className="text-stone-600 text-sm">
                ...
                <div className="bg-stone-50 rounded-xl p-6 border border-stone-100">
                  ...
                  <h3 className="font-semibold text-stone-900 mb-2">Responsiveness</h3>
                  <p className="text-stone-600 text-sm">
                ...
                <div className="bg-stone-50 rounded-xl p-6 border border-stone-100">
                  <div className="w-12 h-12 bg-wood-100 rounded-full flex items-center justify-center mb-4">
                  ...
                  <h3 className="font-semibold text-stone-900 mb-2">Quality</h3>
                  <p className="text-stone-600 text-sm">
